<template>
  <div
    class="pt-0 m-3 page-header align-items-start min-vh-40 pb-7 border-radius-lg"
    :style="{
        ...
        <div class="card z-index-0">
          ...
          <div class="px-3 row px-xl-5 px-sm-4">
            ...
            <div class="mt-2 position-relative text-center">
              ...
              >o crea tu cuenta fácilmente</p>
            </div>
          </div>
          <div class="card-body">
            <form role="form">
              <div class="mb-3">
                <vsud-input type="text" placeholder="Name" aria-label="Name" iconDir="left" icon="las la-user" />
              </div>
              <div class="mb-3">
                <vsud-input type="email" placeholder="Email" aria-label="Email" iconDir="left" icon="las la-envelope" />
              </div>
              <div class="mb-3">
                <vsud-input type="password" placeholder="Password" aria-label="Password" iconDir="left" icon="las la-lock" />
              </div>
              ...
              <div class="text-center">
                <vsud-button color="primary" full-width variant="" class="my-4 mb-2 justify-content-center">Completar Registro</vsud-button>
              </div>
              <p class="text-sm mt-3 mb-0 text-center">
                ¿Ya tienes cuenta?
                <router-link class="text-primary font-weight-bold" :to="'login'">
                  Ingresar
                </router-link>
              </p>
            </form>
...
import bgImg from "@/assets/img/bg-register.jpg"
export default {
  name: "SignUp",
  components: {
    AppFooter,
